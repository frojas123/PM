...
const getStatusInfo = (status: TrainingStatus): { color: string; icon: string } => {
    switch (status) {
...
const TrainingCard: React.FC<{ training: Training; onEdit: (training: Training) => void }> = ({ training, onEdit }) => {
